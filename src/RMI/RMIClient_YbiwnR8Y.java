/*
[Mã câu hỏi (qCode): YbiwnR8Y].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện cho phép triệu gọi từ xa để xử lý dữ liệu.
Giao diện từ xa:
 ...
 * @author OS
 */
public class RMIClient_YbiwnR8Y {
